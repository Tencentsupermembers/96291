package com.monke.work.widget.contentswitchview;
...
import com.monke.work.ReadBookControl;
import com.monke.work.widget.MTextView;
...
public class BookContentView extends FrameLayout {
    ...
    private void init() {
        ...
        tvContent = (com.monke.work.widget.MTextView) view.findViewById(R.id.tv_content);
